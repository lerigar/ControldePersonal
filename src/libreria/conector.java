...
public class conector {
	 ...
	 * de la BD, 1=usuario y 2=contraseña. NOTA: Siempre al usar esta funcion,
	 ...
	 * ingresa directamente el querty como cadena y regresando cualquier valor a
	...
	public String[] ejecutaQWERTY(String qwerty) {
		...
		try {
			for (int i = 0; resultados.next(); i++) {
				resultado[i] = resultados.getString(0);
			}
		} catch (SQLException e) {
			e.printStackTrace();
			System.out
